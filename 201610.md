...
[inside-microsoft](http://www.nature.com/news/inside-microsoft-s-quest-for-a-topological-quantum-computer-1.20774) Inside Microsoft’s quest for a topological quantum computer `Alex Bocharov explains why the company is hoping to build qubits out of particles that some scientists think might not even exist.` `16-Gibney` `microsoft` `stationQ` `topological quantum computer`
